...
- **배경** : 대다수(88%) 시각장애인은 잔존시력과 함께 지팡이와 같은 도구에 의존하여 외출한다. 점자블록, 음향신호기 등 안내를 위한 시각장애인용 인프라가 있지만, 미설치 또는 파손된 경우도 흔히 볼 수 있다. 잔존시력을 가진 사용자에게 보행을 돕는 정보를 제공하여 **안전한 독립보행에 기여**하고자 한다.   
- **개발 목표**
  - 실시간 영상처리를 활용하여 **보행하면서** 사용 가능하도록 구현
  - 
- **기대 효과** : 시각장애인들이 독립적으로...
